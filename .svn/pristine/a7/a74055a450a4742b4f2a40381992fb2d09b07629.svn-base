...
<head>
<meta charset="utf-8">
<title>상장회사일괄등록 | 회사 | 네트워크 | PASS (Project based Activity analysis and Sharing system)</title>
...
<script>
	...
	function doUpload() {
		...
		$('#fileForm').attr('action', "<c:url value='/company/uploadCompanyInfoProcess.do'/>").submit();
	}
	...
	//csv양식다운로드
	function downTmpl(){
		var downPop = window.open('<c:url value="/data/csvTmpl/companyInfo2.csv" />');
	}
...
<div id="compnay_dinfo">
		...
		<div class="modalWrap2">
			<h1><strong>[상장회사 일괄등록]</strong> 상장회사업로드</h1>
			<div class="mo_container">
				<h3 class="h3_title_basic"><span>상장회사 CSV 업로드</span><span class="spe_color_st5 mgl6">(상장회사 일괄등록ㆍ수정가능)</span></h3>
				<div class="cvsuploadWrap">
					<div class="re_CompanyList">
						<ul class="gray_dot_list">
							<li><span>상장회사정보를 CSV양식에 맞춰 작성 후 업로드 하시면 회사등록 및 수정이 일괄적으로 적용됩니다.</span><button type="button" class="btn_b_skyblue mgl10" onclick="downTmpl()"><em class="icon_down">CSV양식 다운</em></button> <a href="#"></a></li>
				...
				<div id="CompanySerach">
					<table class="tb_ProfileInfo" summary="회사검색">
						...
						<tbody>
							<tr>
								<th scope="row" rowspan="2" class="bgGray"><label for="company">상장회사 CSV 파일</label></th>
								<td>
