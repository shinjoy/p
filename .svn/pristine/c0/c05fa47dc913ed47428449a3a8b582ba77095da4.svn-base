...
<div class="doc_viewWarp">
    ...
    <div class="doc_viewWarp2">
        ...
        <h3 class="print_h3title">구매신청서</h3>
        <table class="doc_print_tb_st01" summary="구매신청서 보기(작성자, 신청일, 소속(직위), 연락처, 휴가기간, 휴가기간, 휴가내용, 업무대행자, 대결자, 참조인)">
            ...
            <tbody>
                                ...
                                <tbody>
                                    <c:forEach items="${detailMap.buyList}" var = "data">
                                        <tr>
                                            ...
                                            <td class="txt_center"><fmt:formatNumber type="CURRENCY" pattern="#,##0" value="${data.qty}" /></td>
                                            <td class="txt_right">
                                                <c:set var="money" value="${data.price*data.qty}"/>
                                                <fmt:formatNumber type="CURRENCY" pattern="#,##0" value="${money }" />
                                            </td>
                                            <td class="txt_left">${data.memo}</td>
                                        </tr>
                                    </c:forEach>
                ...
                <tr>
                    ...
                    <td colspan="3"><c:out value="${fn:replace(detailMap.siteUrl, LF, '<br>')}" escapeXml="false"/></td>
                </tr>
                <tr id = "fileViewArea">
                    <th scope="row">
                    	첨부파일
