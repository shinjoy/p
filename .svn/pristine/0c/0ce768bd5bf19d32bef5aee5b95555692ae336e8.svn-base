					...
					<ul class="tx-bar tx-bar-left tx-nav-attach">
						...
						<li class="tx-list">
							<div unselectable="on" id="tx_image" class="tx-image tx-btn-trans">
								<a href="javascript:;" title="사진첨부" class="tx-text">사진첨부</a>
							</div>
						</li>
						<%if(type.equals("board")){ %>
						<li class="tx-list">
							<div unselectable="on" id="tx_media" class="tx-media tx-btn-trans">
								<a href="javascript:;" title="외부이미지" class="tx-text">외부이미지</a>
							</div>
						</li>
						<% }%>
...
var config = {
		...
		txIconPath: contextRoot +"/daumeditor/images/icon/editor/", /*에디터에 사용되는 이미지 디렉터리, 필요에 따라 수정한다. */
		txDecoPath: contextRoot +"/daumeditor/images/deco/contents/", /*본문에 사용되는 이미지 디렉터리, 서비스에서 사용할 때는 완성된 컨텐츠로 배포되기 위해 절대경로로 수정한다. */
		canvas: {
			styles: {
				color: "#123456", /* 기본 글자색 */
