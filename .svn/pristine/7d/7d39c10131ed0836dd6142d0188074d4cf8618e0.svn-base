...
<script>
	...
	//csv양식다운로드
	function downTmpl(){
		var downPop = window.open('<c:url value="/data/csvTmpl/companyInfo.csv" />');
	}
...
<div id="compnay_dinfo">
		...
		<div class="modalWrap2">
			<h1><strong>[회사 일괄등록]</strong> 회사업로드</h1>
			<div class="mo_container">
				<h3 class="h3_title_basic"><span>회사 CSV 업로드</span><span class="spe_color_st5 mgl6">(회사 일괄등록ㆍ수정가능)</span></h3>
				<div class="cvsuploadWrap">
					<div class="re_CompanyList">
						<ul class="gray_dot_list">
							<li><span>회사정보를 CSV양식에 맞춰 작성 후 업로드 하시면 회사등록 및 수정이 일괄적으로 적용됩니다.</span><button type="button" class="btn_b_skyblue mgl10" onclick="downTmpl()"><em class="icon_down">CSV양식 다운</em></button> <a href="#"></a></li>
				...
				<div id="CompanySerach">
					<table class="tb_ProfileInfo" summary="회사검색">
						...
						<tbody>
							<tr>
								<th scope="row" rowspan="2" class="bgGray"><label for="company">회사 CSV 파일</label></th>
								<td>
