...
public class NetworkState
{
	...
	public static List<String > getMyPortScan()
	{
		...
		try {
			...
			if ("WINDOWS".equals(Globals.OS_TYPE)) {
				...
				String cmdStr = IBsProperties.getPathProperty(Globals.SERVER_CONF_PATH, "SHELL."+Globals.OS_TYPE+".getNetWorkInfo");
	...
	public static String getMyIPaddress()
	{
		try {
			...
			if (!WebUtil.isIPAddress(InetAddress.getLocalHost ().getHostAddress())) {	// 2011.10.25 보안점검 후속조치
