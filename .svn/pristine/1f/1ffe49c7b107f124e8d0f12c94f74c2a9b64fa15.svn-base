...
! function(e) {
    ...
    return d = e.fullCalendar, d.schedulerVersion = "1.5.1", 8 !== d.internalApiVersion ? void d.warn("v" + d.schedulerVersion + " of FullCalendar Scheduler is incompatible with v" + d.version + " of the core.\nPlease see http://fullcalendar.io/support/ for more information.") : (s = d.Calendar, n = d.Class, K = d.View, f = d.Grid, be = d.intersectRanges, ue = d.debounce, He = d.isInt, we = d.getScrollbarWidths, h = d.DragListener, Se = d.htmlEscape, re = d.computeIntervalUnit, Pe = d.proxy, ee = d.capitaliseFirstLetter, Z = d.applyAll, c = d.EmitterMixin, v = d.ListenerMixin, pe = d.durationHasTime, ae = d.divideRangeByDuration, ce = d.divideDurationByDuration, Ie = d.multiplyDuration, ke = d.parseFieldSpecs, te = d.compareByFieldSpecs, de = d.flexibleCompare, Ce = d.intersectRects, l = d.CoordCache, fe = d.getContentRect, ge = d.getOuterRect, ie = d.createObject, C = d.Promise, V = d.TaskQueue, ye = function(e) {
            ...
            return e.scrollEl.on("wheel mousewheel DomMouseScroll MozMousePixelScroll", function(t) {
                ...
                return function() {
                    ...
                    if (e === t.masterScroller) {
                        for (n = t.scrollers, i = [], r = 0, s = n.length; r < s; r++)
                            if (o = n[r], o !== e) switch (t.axis) {
                                case "horizontal":
        ...
        return Ye(r, t), r.prototype.resourceManager = null, r.prototype.initialize = function() {
            ...
            for (f = r.__super__.getPeerEvents.apply(this, arguments), p = e.resourceId ? [e.resourceId] : t ? this.getEventResourceIds(t) : [], s = [], n = 0, u = f.length; n < u; n++) {
                if (d = f[n], o = !1, y = this.getEventResourceIds(d), y.length && p.length) {
                    for (i = 0, h = y.length; i < h; i++)
                        for (g = y[i], l = 0, c = p.length; l < c; l++)
                            if (a = p[l], a === g) {
                                o = !0;
                                break
                            }
            ...
            if (s) {
                for (t = [], u = 0, a = i.length; u < a; u++)
                    for (d = i[u], n = this.computeBusinessHourEvents(e, d.businessHours || this.options.businessHours), h = 0, p = n.length; h < p; h++) o = n[h], o.resourceId = d.id, t.push(o);
                return t
            }
            ...
            var t, r, s, o, n, i, l;
            if (t = "object" == typeof e ? e : this.clientEvents(e)[0], l = [], t)
                for (o = this.getEventResourceIds(t), r = 0, s = o.length; r < s; r++) i = o[r], n = this.getResourceById(i), n && l.push(n);
            return l
        }, r
        ...
        var r;
        return r = this.opt("refetchResourcesOnNavigate"), this.unbindEvents(), r && this.unbindResources({
            skipUnrender: !0
        }), this.requestDateRender(e).then(function(e) {
            return function() {
        ...
        var t, r, s, o, n;
        for (o = this.getSegResources(e), r = 0, s = o.length; r < s; r++)
            for (t = o[r]; t;) {
        ...
        return Ye(r, t), r.mixin(c), r.resourceGuid = 1, r.ajaxDefaults = {
            ...
            var n, i, l, u;
            switch (n = this.calendar, i = n.options, u = i.resources, "string" === e.type(u) && (u = {
                url: u
            }), e.type(u)) {
                case "function":
                ...
                case "object":
                    return n.pushLoading(), l = {}, s && o && (l[i.startParam] = s.format(), l[i.endParam] = o.format(), i.timezone && "local" !== i.timezone && (l[i.timezoneParam] = i.timezone)), e.ajax(e.extend({
                        data: l
                    }, r.ajaxDefaults, u)).then(function(e) {
                        return function(e) {
        ...
        filterResourcesWithEvents: function(e, t) {
            var r, s, o, n, i, l, u, h;
            for (h = {}, s = 0, n = t.length; s < n; s++)
                for (r = t[s], l = this.calendar.getEventResourceIds(r), o = 0, i = l.length; o < i; o++) u = l[o], h[u] = !0;
            return J(e, h)
        }
    }, J = function(e, t) {
        var r, s, o, n, i, l;
        ...
        eventRangeToSpans: function(t, r) {
            var s, o, n, i, l;
            if (i = this.view.calendar.getEventResourceIds(r), i.length) {
                for (l = [], s = 0, o = i.length; s < o; s++) n = i[s], l.push(e.extend({}, t, {
                    resourceId: n
                }));
                return l
            }
        ...
        renderHeadResourceAndDateHtml: function() {
            ...
            for (h = [], t = [], i = this.flattenedResources, s = 0, n = i.length; s < n; s++)
                for (u = i[s], h.push(this.renderHeadResourceCellHtml(u, null, this.daysPerRow)), r = o = 0, l = this.daysPerRow; o < l; r = o += 1) e = this.dayDates[r].clone(), t.push(this.renderHeadResourceDateCellHtml(e, u));
            return this.wrapTr(h, "renderHeadIntroHtml") + this.wrapTr(t, "renderHeadIntroHtml")
        },
        renderHeadDateAndResourceHtml: function() {
            var e, t, r, s, o, n, i, l, u, h;
            for (t = [], h = [], r = s = 0, i = this.daysPerRow; s < i; r = s += 1)
                for (e = this.dayDates[r].clone(), t.push(this.renderHeadDateCellHtml(e, this.resourceCnt)), l = this.flattenedResources, o = 0, n = l.length; o < n; o++) u = l[o], h.push(this.renderHeadResourceCellHtml(u, e));
            return this.wrapTr(t, "renderHeadIntroHtml") + this.wrapTr(h, "renderHeadIntroHtml")
        },
        renderHeadResourceCellHtml: function(e, t, r) {
            return '<th class="fc-resource-cell"   style="color:'+e.textColor+'"    data-resource-id="' + e.id + '"' + (t ? ' data-date="' + t.format("YYYY-MM-DD") + '"' : "") + (r > 1 ? ' colspan="' + r + '"' : "") + ">" + Se(this.view.getResourceText(e)) + "</th>"
        },
        ...
        return Ye(r, t), r.mixin(D), r.mixin(I), r.prototype.getHitSpan = function(e) {
            ...
            if (c = this.resourceCnt, s = this.datesAboveResources ? this.sliceRangeByDay(t) : this.sliceRangeByRow(t), c) {
                for (d = [], n = 0, u = s.length; n < u; n++)
                    for (f = s[n], a = i = 0, h = c; i < h; a = i += 1) p = this.flattenedResources[a], t.resourceId && t.resourceId !== p.id || (r = e.extend({}, f), r.resource = p, this.isRTL ? (r.leftCol = this.indicesToCol(a, f.lastRowDayIndex), r.rightCol = this.indicesToCol(a, f.firstRowDayIndex)) : (r.leftCol = this.indicesToCol(a, f.firstRowDayIndex), r.rightCol = this.indicesToCol(a, f.lastRowDayIndex)), d.push(r));
                return d
            }
        ...
        return Ye(r, t), r.mixin(D), r.mixin(I), r.prototype.getHitSpan = function(e) {
            ...
            if (c = this.resourceCnt, s = this.sliceRangeByTimes(t), c) {
                for (d = [], n = 0, u = s.length; n < u; n++)
                    for (f = s[n], a = i = 0, h = c; i < h; a = i += 1) p = this.flattenedResources[a], t.resourceId && t.resourceId !== p.id || (r = e.extend({}, f), r.resource = p, r.col = this.indicesToCol(a, f.dayIndex), d.push(r));
                return d
            }
        ...
        return Ye(s, r), s.prototype.slotDates = null, s.prototype.slotCnt = null, s.prototype.snapCnt = null, s.prototype.snapsPerSlot = null, s.prototype.snapDiffToIndex = null, s.prototype.snapIndexToDiff = null, s.prototype.headEl = null, s.prototype.slatContainerEl = null, s.prototype.slatEls = null, s.prototype.containerCoordCache = null, s.prototype.slatCoordCache = null, s.prototype.slatInnerCoordCache = null, s.prototype.headScroller = null, s.prototype.bodyScroller = null, s.prototype.joiner = null, s.prototype.follower = null, s.prototype.eventTitleFollower = null, s.prototype.minTime = null, s.prototype.maxTime = null, s.prototype.timeWindowMs = null, s.prototype.slotDuration = null, s.prototype.snapDuration = null, s.prototype.duration = null, s.prototype.labelInterval = null, s.prototype.headerFormats = null, s.prototype.isTimeScale = null, s.prototype.largeUnit = null, s.prototype.emphasizeWeeks = !1, s.prototype.titleFollower = null, s.prototype.segContainerEl = null, s.prototype.segContainerHeight = null, s.prototype.bgSegContainerEl = null, s.prototype.helperEls = null, s.prototype.innerEl = null, s.prototype.opt = function(e) {
            ...
            var r, s, o;
            return o = [], t = this.normalizeGridDate(t), t >= this.start && t < this.end && (r = this.dateToCoord(t), s = this.isRTL ? {
                right: -r
            } : {
                left: r
            }, o.push(e("<div class='fc-now-indicator fc-now-indicator-arrow'></div>").css(s).appendTo(this.headScroller.canvas.el)[0]), o.push(e("<div class='fc-now-indicator fc-now-indicator-line'></div>").css(s).appendTo(this.bodyScroller.canvas.el)[0])), this.nowIndicatorEls = e(o)
            ...
            for (s = 0, i = e.length; s < i; s++)
                for (w = e[s], t = w[0], H = w[1], o = 0, l = H.length; o < l; o++) E = H[o], r = this.rangeToCoords(E), E.el.css({
                    left: E.left = r.left,
                    right: -(E.right = r.right)
                });
            for (n = 0, u = e.length; n < u; n++)
                for (m = e[n], t = m[0], H = m[1], f = 0, h = H.length; f < h; f++) E = H[f], E.el.appendTo(t.segContainerEl);
            ...
            var r;
            return r = this.eventToSegs(e), r = this.renderFgSegEls(r), this.renderHelperSegsInContainers([
                [this, r]
            ], t)
        }, s.prototype.renderHelperSegsInContainers = function(t, r) {
            var s, o, n, i, l, u, h, c, a, p, d, f, g, y, v, R, w, m;
            for (i = [], w = [], l = 0, c = t.length; l < c; l++)
                for (g = t[l], s = g[0], m = g[1], u = 0, a = m.length; u < a; u++) R = m[u], o = this.rangeToCoords(R), R.el.css({
                    left: R.left = o.left,
            ...
            for (h = 0, p = t.length; h < p; h++)
                for (v = t[h], s = v[0], m = v[1], n = e('<div class="fc-event-container fc-helper-container"/>').appendTo(s.innerEl), i.push(n[0]), f = 0, d = m.length; f < d; f++) R = m[f], n.append(R.el), w.push(R.el[0]);
        ...
        milliseconds: 1
    }], j.prototype.initScaleProps = function() {
        var t, r, s;
        ...
        if (e = this.duration, !e) {
            if (e = this.view.intervalDuration, !e)
                if (this.labelInterval || this.slotDuration)
                    for (n = this.ensureLabelInterval(), s = O.length - 1; s >= 0 && (r = O[s], e = t.duration(r), o = ce(e, n), !(o >= S)); s += -1);
                else e = t.duration(u);
            this.duration = e
        }
        return e
        ...
        if (n = this.labelInterval, !n) {
            if (this.duration || this.slotDuration || this.ensureGridDuration(), this.slotDuration) {
                for (r = 0, i = O.length; r < i; r++)
                    if (e = O[r], h = t.duration(e), u = ce(h, this.slotDuration), He(u) && u <= w) {
                        n = h;
                        break
                    }
                n || (n = this.slotDuration)
            } else
                for (s = 0, l = O.length; s < l && (e = O[s], n = t.duration(e), o = ce(this.duration, n), !(o >= S)); s++);
        ...
        if (i = this.slotDuration, !i) {
            for (s = this.ensureLabelInterval(), r = 0, o = O.length; r < o; r++)
                if (e = O[r], u = t.duration(e), l = ce(s, u), He(l) && l > 1 && l <= w) {
                    i = u;
                    break
                }
    ...
    }, d.views.timelineWeek = {
        type: "timeline",
        duration: {
            weeks: 1
        }
    }, d.views.timelineMonth = {
        type: "timeline",
        duration: {
            months: 1
        }
    }, d.views.timelineYear = {
        type: "timeline",
        duration: {
            years: 1
        }
        ...
        return Ye(r, t), r.mixin(L), r.prototype.canRenderSpecificResources = !0, r.prototype.resourceGrid = null, r.prototype.tbodyHash = null, r.prototype.joiner = null, r.prototype.dividerEls = null, r.prototype.superHeaderText = null, r.prototype.isVGrouping = null, r.prototype.isHGrouping = null, r.prototype.groupSpecs = null, r.prototype.colSpecs = null, r.prototype.orderSpecs = null, r.prototype.rowHierarchy = null, r.prototype.resourceRowHash = null, r.prototype.nestingCnt = 0, r.prototype.isNesting = null, r.prototype.dividerWidth = null, r.prototype.initialize = function() {
            ...
            for (w[0].isMain = !0, o.length ? (i = o, c = !0) : (l = this.opt("resourceGroupField"), l && (h = !0, i.push({
                ...
                for (R = t[p], u = !1, d = 0, v = i.length; d < v; d++)
                    if (n = i[d], n.field === R.field) {
                        n.order = R.order, u = !0;
                        break
                    }
                u || m.push(R)
            ...
            if (this.orderSpecs.length)
                for (i = t.children, s = o = 0, n = i.length; o < n; s = ++o)
                    if (l = i[s], r = this.compareResources(l.resource || {}, e.resource || {}), r > 0) return s;
            return null
            ...
            if (n = (e.resource || {})[r.field], o = null, r.order)
                for (a = t.children, i = l = 0, h = a.length; l < h; i = ++l) {
                    ...
                    for (p = t.children, i = u = 0, c = p.length; u < c; i = ++u)
                        if (d = p[i], d.groupValue === n) {
                            o = d;
                            break
                        }
            ...
            var e, t, s, o, n, i, l, u;
            for (l = r.__super__.queryScroll.apply(this, arguments), u = this.timeGrid.bodyScroller.scrollEl.offset().top, n = this.getVisibleRows(), s = 0, o = n.length; s < o; s++)
                if (i = n[s], i.resource && (e = i.getTr("event"), t = e.offset().top + e.outerHeight(), t > u)) {
        ...
        return Ye(r, t), r.mixin(D), r.prototype.eventRows = null, r.prototype.shownEventRows = null, r.prototype.tbodyEl = null, r.prototype.rowCoordCache = null, r.prototype.spanToSegs = function(e) {
            var t, s, o, n, i, l;
            if (l = r.__super__.spanToSegs.apply(this, arguments), t = this.view.calendar, n = e.resourceId)
                for (s = 0, o = l.length; s < o; s++) i = l[s], i.resource = t.getResourceById(n), i.resourceId = n;
            return l
        }, r.prototype.prepareHits = function() {
            var e, t;
            return r.__super__.prepareHits.apply(this, arguments), this.eventRows = this.view.getEventRows(), this.shownEventRows = function() {
                ...
                return o
            }.call(this), this.rowCoordCache = new l({
                els: t,
                isVertical: !0
        ...
        return t.prototype.view = null, t.prototype.parent = null, t.prototype.prevSibling = null, t.prototype.children = null, t.prototype.depth = 0, t.prototype.hasOwnRow = !1, t.prototype.trHash = null, t.prototype.trs = null, t.prototype.isRendered = !1, t.prototype.isExpanded = !0, t.prototype.isShown = !1, t.prototype.addChild = function(e, t) {
            ...
            for (t = this.children, s = !1, r = o = 0, i = t.length; o < i; r = ++o)
                if (c = t[r], c === e) {
                    s = !0;
                    break
                }
        ...
        return Ye(t, e), t.prototype.hasOwnRow = !0, t.prototype.segContainerEl = null, t.prototype.segContainerHeight = null, t.prototype.innerEl = null, t.prototype.bgSegContainerEl = null, t.prototype.isSegsRendered = !1, t.prototype.isBusinessHourSegsRendered = !1, t.prototype.businessHourSegs = null, t.prototype.bgSegs = null, t.prototype.fgSegs = null, t.prototype.renderEventContent = function(e) {
            ...
            if (!this.isSegsRendered) return this.ensureBusinessHourSegsRendered(), this.bgSegs && this.view.timeGrid.renderFillInContainer("bgEvent", this, this.bgSegs), this.fgSegs && this.view.timeGrid.renderFgSegsInContainers([
                [this, this.fgSegs]
