...
import ib.login.service.LoginPolicy;
import ib.login.service.LoginPolicyVO;
import egovframework.rte.fdl.cmmn.AbstractServiceImpl;

@Service("egovLoginPolicyService")
public class LoginPolicyServiceImpl extends AbstractServiceImpl implements LoginPolicyService {
