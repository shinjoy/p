...
<%@ include file="./js/modifyApproveReport_JS.jsp" %>
...
<form id = "frm" name = "frm" method="post">
	<!-- DocClass 고정.... -->
	<input type="hidden" id = "appvDocClass" name = "appvDocClass" value="REPORT">

	<!-- 연차휴가만 고정...(16.10.20) -->
	<input type="hidden" id = "appvDocType" name = "appvDocType" value="REPORT">
	...
	<div class="doc_AllWrap">
		<c:if test="${popYn eq 'M' }"><h3 style="font-family:'NanumBarun'; font-size:30px; letter-spacing:0; text-align:center; line-height:1.4; ">보고서</h3></c:if>
		<!--기본양식/완료보고작성-->
		<table class="tb_regi_basic" summary="교육신청/완료보고 (문서종류, 결재자, 신청자, 연락처, 소속/직위,연락처, 휴가기간, 사용일/잔여일, 사유, 업무인수자, 대결자, 참조인선택)">
			...
			<tbody>
				...
				<tr>
					...
					<th scope="row"><label for="IDNAME05">일정</label></th>
					<td>
	    ...
	    <table id="lineTable" class="datagrid_input" summary="결재라인 관리 (문서이름, 타입, 금액, 사용여부, 마감여부, 수정자, 등록자)"  arrayVoName="approveVoList" >
	        ...
	        <tbody>
	            ...
	            <tr id="lineTableTr">
	                ...
	                <td>
	                    <select id="appVoList.appvLineType" name="appVoList.appvLineType"  onChange="changeAppvLineType(this);"  disabled = "disabled" class="select_b w100pro" title="결재유형선택">
