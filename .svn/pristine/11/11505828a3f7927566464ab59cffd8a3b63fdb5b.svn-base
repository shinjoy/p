...
public class PersonDAO extends ComAbstractDAO{
	...
	//삭제 대상 회사 조회
	public Integer getDeleteCustomerInfo(Map<String,Object> paramMap) throws Exception {
		return (Integer)getSqlMapClientTemplate().queryForObject("person.getDeleteCustomerInfo", paramMap);
	}
	//회사 삭제
	public Integer deleteCustomerInfo(Map<String,Object> paramMap) throws Exception {
		return delete("person.deleteCustomerInfo",paramMap);
	}
}