...
var colorObj = {};
//문서종류 등록 선택박스
var comCodeAppvDocClass = getBaseCommonCode('APPV_DOC_CLASS', null, 'CD', 'NM', '', '문서종류선택', null, { orgId : "${baseUserLoginInfo.applyOrgId}" });
...
function appvDocClassChg(index){
	...
	$("#"+targetClassTagId).find("#appvDocClass").change(function(){
		...
		if(appvDocClass!="COMPANY"){
        	//문서종류 검색 선택박스
    		var comCodeAppvDocType = getBaseCommonCode('APPV_DOC_TYPE_'+appvDocClass, null, 'CD', 'NM', '', '문서타입선택', null, { orgId : "${baseUserLoginInfo.applyOrgId}" });
...
<div class="mo_container">
		...
		<div class="btnZoneBox">
			<button id="btnDel" type="button" onclick="doCopy();" class="p_blueblack_btn btn_auth">복사</button>
			<button id="btnDel" type="button" onclick="deleteCopyLine();" class="p_withelin_btn btn_auth">삭제</button>
		</div>
		<div class="btnZoneBox">
