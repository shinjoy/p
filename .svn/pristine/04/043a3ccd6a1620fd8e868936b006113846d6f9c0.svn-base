...
<script type="text/javascript" defer="defer">
	...
	$(document).ready(function(){
        ...
        $("#appvDocType").val("${detailMap.appvDocTypeSelect}");
        $("#appvDocTypeSelect").val("${detailMap.appvDocTypeSelect}");
        //$("#appvDocTypeSelect").prop("disabled",true);

        appvDocTypeChg();

        $("#appvHeaderId").val("${detailMap.appvHeaderId}");
		...
		$("#appvDocType").val("${detailMap.appvDocType }");
	...
	function chkAppointedPersonCallback(data){
		if(data.resultObject.result =="SUCCESS"){
			...
			var appvDocTypeStr ="${detailMap.appvDocType }";
