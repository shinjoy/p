	...
	<tbody>
		<tr>
               ...
               <tr>
                   ...
                   <td colspan="3">
                   		<span id="v_viewEmployee2"></span>
                   		<span id="v_viewEmployee_list2"></span>
                   </td>
               </tr>
	</tbody>
</table>
...
var fnObj2 = {
    ...
    pageStart: function(){
    	...
    	rowHtmlStr +=	 '<td class="joinmb_list" onclick="fnObj2.getDetailActivity(\'#[10]\',\'#[11]\',\'#[12]\')">#[8]</td>';
        rowHtmlStr +=	 '</tr>';
    ...
    setProjectInfo: function(){
	    	...
	    	$('#v_viewEmployee2').html(viewEntryList.length > 0 ? '<strong style="color:red;">Y</strong>' : 'N');			//지켜보는직원
			...
			$('#v_viewEmployee_list2').html(vStr);
...
function moveModifyPage(){
	...
	$("#moveForm").attr("action",contextRoot + "/project/projectReg.do?saved=&pId="+project.projectId);

	var newWin = window.open("about:blank","projectModifyPop");
	$("#moveForm").attr("target","projectModifyPop");
