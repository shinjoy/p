    ...
    function html5Upload(URL) {	
    	var tempFile,
    		sUploadURL;
//    	sUploadURL= "http://localhost:8080/SynergyCus/Html5PhotoView.do"; 	//upload URL
//    	sUploadURL= "http://106.250.177.91:8280/SynergyCus/Html5PhotoView.do"; 	//upload URL
    	sUploadURL= URL; 	//upload URL
...
// 			sUrl  : "<c:url value='/PhotoView.do'/>",	//샘플 URL입니다.
