...
<div style="min-height:500px;">
	<div style="padding:10px;">
            ...
            <div class="rightblock" style="float:right; margin-bottom: 5px;">
                <input id="srch_cpnNm" type="text" placeholder="관계사 명 " onkeypress="if(event.keyCode==13) fnObj.doSearch(1);" class="input_b" title="관계사 명" />
                <a href="#" onclick="fnObj.doSearch(1);" class="btn_s_type_g">검색</a>
            </div>
		   ...
		   <!-- 프로젝트 목록 -->
			<table id="SGridTarget" class="datagrid_basic" summary="관계사 목록">
	            ...
	            <thead>
	                <tr>
	                	<th scope="col">순번</th>
	                	<th scope="col"><a href="#" onclick="fnObj.doSort(0);" id="sort_column_prefix0" class="sort_normal">관계사 명<em>정렬</em></th>
	                	<th scope="col">관계사 코드</th>
	                	<th scope="col"><a href="#" onclick="fnObj.doSort(0);" id="sort_column_prefix0" class="sort_normal">비즈니스 그룹명<em>정렬</em></a></th>
	                    <!-- <th scope="col">GROUPING 관계사 여부</th> -->
	               </tr>
	            </thead>
	            <tbody>
	            </tbody>
...
var fnObj = {
    ...
    doSearch : function(page){
    	    	...
    	    	var url = contextRoot + "/user/orgAuthCompanyPopList.do";
    	    	var param = {
    			    			pageSize: pageSize,
    			    			pageNo:	page,
  	...
  	//소속관계사 정보 부모창에 전달
    setOrgComp: function(item){
    	parent.fnObj.setOrgId(item);
