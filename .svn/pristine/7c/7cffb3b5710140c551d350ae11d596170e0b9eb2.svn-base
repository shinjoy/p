...
<script type="text/javascript" defer="defer">
	...
	$(document).ready(function(){
		if($("#familyEventsIdSelect option").length == 0 ){
			alert("등록된 경조사 분류가 없습니다. 관리자에게 문의해 주세요.");
		}else{
	...
	function setProjectArea(){
		var commonPropject = getCommonProject('CD', 'NM', '', '${baseUserLoginInfo.projectTitle } 선택', { orgId : '${baseUserLoginInfo.orgId }',userId : $("#selectStaffId").val(),type:"PROJECT",incApproveActivity:"N",startDate:nowStr});
