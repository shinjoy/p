...
<%@ include file="./js/draftDocList_JS.jsp" %>
...
<form id ="frm" name = "frm" method="post">
	...
	<!--//게시판정렬목록//-->
	<div id = "listArea">
		<jsp:include page="./include/draftDocList_INC.jsp"></jsp:include>
	</div>
...
<div class="btn_baordZone">
	...
	<a href="javascript:processDocSubmitAll()" class="btn_blueblack btn_auth">상신</a>
