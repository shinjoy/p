...
<section id="detail_contents">
	<div class="board_classic">
		<div class="leftblock">
			...
			<a class="btn_s_type3 mgl15" href="javascript:fnObj.openHelpModalPop()"><em class="icon_info">코드관리 사용안내</em></a>
		</div>
    ...
    <br/>
	<h3 class="sys_grid_title btn_auth">[ 코드SET - <span id="displayCodeNm" class="pointsetcolor"></span><span id="displayMode">신규등록</span> ]</h3>
	<table class="datagrid_input btn_auth" summary="코드SET 입력 (코드SET, 코드SET명, 코드SET영문, 코드타입, 설명, 초기화)">
	...
	<div class="btn_baordZone2 btn_auth">
	...
	<div class="btn_baordZone2">
        <a href="javascript:fnObj.doSaveCoseList();" class="btn_blueblack btn_auth"><span id="editBtnName">저장</span></a>
        <!-- <a href="javascript:fnObj.tryDel();" id="deleteBtn" class="btn_witheline">삭제</a> -->
    </div>



	<!--<h3 class="h3_title_basic mgb10">코드SET</h3>
	<div class="sys_search_box">
		<div id="AXSearchTarget" class="fl_block"></div>
		<div class="fr_block">
			<button name="reg_btn" class="btn_b2_skyblue" onclick="fnObj.excelDownload();"><em class="icon_XLS">파일로 저장</em></button>
	...
	<div class="mgb10">
	 ...
	 <div style="width:100%; margin-bottom:20px;">
		<div style="width:100%;">
		코드SET 선택 정보
		<button type="button" class="AXButton Classic" style="margin-top:1px;height:23px;line-height:23px;" onclick="fnObj.resetCodeSet();">신규추가</button>
		<input id="inputCodeSetId" type="text" name="codeSetId" placeholder="신규" value="" class="AXInput W30 av-bizno" readonly="readonly" style="display:none;" />
		&nbsp;<input id="inputCodeSetName" type="text" name="codeSetName" placeholder="코드SET" value="" class="AXInput W130 av-bizno" />
		&nbsp;<input id="inputMeaningKor" type="text" name="meaningKor" placeholder="코드SET한글명" value="" class="AXInput W130 av-bizno" />
		&nbsp;<input id="inputMeaningEng" type="text" name="meaningEng" placeholder="코드SET영문" value="" class="AXInput W130 av-bizno" />
		&nbsp;<span id="codeTypeSelectTag"></span>
		&nbsp;<span id="codeGroupSelectTag" style="display:none;"></span>
		&nbsp;<input id="inputDesc" type="text" name="description" placeholder="설명" value="" class="AXInput W140 av-bizno" />
		&nbsp;삭제여부
		<span id="deleteFlagSelectTag"></span>
		</div>
		<div style="margin-top:3px;width:100%;">
		<button type="button" class="AXButton Classic" style="margin-top:1px;height:23px;line-height:23px;" onclick="fnObj.openParentIdPop();"><i class="axi axi-search3"></i>&nbsp;&nbsp;부모코드SET</button>
		&nbsp;<button type="button" class="AXButton Classic" style="margin-top:1px;height:23px;line-height:23px;" onclick="fnObj.doRefreshCodeSet();">&nbsp;부모코드 초기화&nbsp;</button>
		<input id="inputParentSetId" type="text" name="parentSetId" placeholder="부모아이디" value="" class="AXInput W60 av-bizno" readonly="readonly" style="display:none;" />
		&nbsp;<input id="inputParentSetName" type="text" name="parentSetName" placeholder="부모코드SET" value="" class="AXInput W130 av-bizno" readonly="readonly"/>
		&nbsp;<input id="inputParentMeaningKor" type="text" name="parentMeaningKor" placeholder="부모코드SET명" value="" class="AXInput W130 av-bizno" readonly="readonly"/>
		&nbsp;<input id="inputParentMeaningEng" type="text" name="parentMeaningEng" placeholder="부모코드SET영문" value="" class="AXInput W130 av-bizno" readonly="readonly"/>

		<button type="button" class="AXButton Classic" style="margin-top:1px;float:right;height:25px;line-height:25ㅔx;"  onclick="fnObj.doSaveCodeSet();"><i class="fa fa-check-circle fa-lg"></i>&nbsp;&nbsp;&nbsp;저&nbsp;&nbsp;&nbsp;&nbsp;장&nbsp;&nbsp;&nbsp;&nbsp;</button>
		</div>
	</div>

	<div style="height:1px;background-color:#ddd;margin-bottom:5px;"></div>
	<div style="height:1px;background-color:#ddd;margin-bottom:5px;"></div>
	<div id="clearFloat"></div>
	<h3 class="h3_title_basic" style="margin-bottom:10px; margin-top:20px; ">코드LIST</h3>

	<div id="codeSetInfoTag" style="margin-top:-20px;margin-left:170px;float:left;"></div>

	<div id="AXGridTarget2" style="margin-top:0px;"></div>

	<div style="width:100%; padding-top:15px;">
		<div style="width:100%;">
		코드LIST 선택 정보
		<button type="button" class="AXButton Classic" style="margin-top:1px;height:23px;line-height:23px;" onclick="fnObj.resetCodeList();">신규추가</button>
		&nbsp;<input id="inputCodeListId" type="text" name="codeListId" placeholder="신규" value="" class="AXInput W50 av-bizno" readonly="readonly" />
		&nbsp;<input id="inputValue" type="text" name="value" placeholder="코드값" value="" class="AXInput W130 av-bizno" />
		&nbsp;<input id="inputMeaningKor2" type="text" name="meaningKor2" placeholder="한글명" value="" class="AXInput W150 av-bizno" />
		&nbsp;<input id="inputMeaningEng2" type="text" name="meaningEng2" placeholder="영문명" value="" class="AXInput W150 av-bizno" />
		&nbsp;<input id="inputSort" type="text" name="sort" placeholder="정렬값" value="" class="AXInput W60 av-bizno" />
		&nbsp;<input id="inputDesc2" type="text" name="description2" placeholder="설명" value="" class="AXInput W150 av-bizno" />
		&nbsp;삭제여부
		<span id="deleteFlagSelectTag2"></span>
		</div>
		<div style="margin-top:3px;width:100%;">
		sonSetCode
		<button type="button" class="AXButton Classic" style="margin-top:1px;height:23px;line-height:23px;" onclick="fnObj.openParentIdPop('list');"><i class="axi axi-search3"></i>&nbsp;&nbsp;자식코드SET</button>
		&nbsp;<button type="button" class="AXButton Classic"style="margin-top:1px;height:23px;line-height:23px;" onclick="fnObj.doRefreshSonset();">자식코드 초기화</button>
		<input id="inputSonSetId" type="text" name="sonSetId" placeholder="자식아이디" value="" class="AXInput W60 av-bizno" readonly="readonly" style="display:none;" />
		&nbsp;<input id="inputSonSetName" type="text" name="sonSetName" placeholder="자식코드SET" value="" class="AXInput W130 av-bizno" readonly="readonly"/>
		&nbsp;<input id="inputSonMeaningKor" type="text" name="sonMeaningKor" placeholder="자식코드SET명" value="" class="AXInput W130 av-bizno" readonly="readonly"/>
		&nbsp;<input id="inputSonMeaningEng" type="text" name="sonMeaningEng" placeholder="자식코드SET영문" value="" class="AXInput W130 av-bizno" readonly="readonly"/>

		<button type="button" class="AXButton Classic" style="margin-top:1px;float:right;height:25px;line-height:25px;"  onclick="fnObj.doSaveCoseList();"><i class="fa fa-check-circle fa-lg"></i>&nbsp;&nbsp;&nbsp;저&nbsp;&nbsp;&nbsp;&nbsp;장&nbsp;&nbsp;&nbsp;&nbsp;</button>
		</div>
	</div> -->
...
var fnObj = {
	...
	preloadCode: function(){
		...
		//공통코드
		comCodeCodeType = getBaseCommonCode('CODE_TYPE', lang, 'CD', 'NM', null, '','', {orgId :'${baseUserLoginInfo.applyOrgId}' } );
		comCodeCodeGroup = getBaseCommonCode('CODE_GROUP', lang, 'CD', 'NM', '', '선택', 'ALL', {orgId :'${baseUserLoginInfo.applyOrgId}'});	//코드그룹 공통코드 (Sync ajax)
    ...
    pageStart: function(){
    	...
    	mySearch.setConfig({
			...
			rows:[
					{display:true, addClass:"", style:"", list:[
   						...
   						{label:"관계사", type:"selectBox", width:"", key:"targetOrgId", addClass:"secondItem mgr10", value:"${baseUserLoginInfo.applyOrgId}",
   							...
   							AXBind:{
   								type:"select", config:{
   									onChange:function(){
   										...
   										fnObj.resetCodeSet('REFRESH'); 	//코드셋 리셋
   									}
   								}
   							},
   						},
    	...
    	myGrid2.setConfig({		//코드LIST 그리드
            ...
            colGroup : [
                ...
                {key:"value",			label:"코드값", 			width:"110",	align:"left",	formatter:function(){return (this.item.deleteFlag == 'Y'?'<strike>':'') + ("<b>" + (this.value) + "</b>");}},
                {key:"meaningKor",		label:"한글명", 			width:"140",	align:"left",	formatter:function(){return (this.item.deleteFlag == 'Y'?'<strike>':'') + ("<b>" + (this.value) + "</b>");}},
                {key:"meaningEng",		label:"영문명", 			width:"140",	align:"left",	formatter:function(){return (this.item.deleteFlag == 'Y'?'<strike>':'') + ("<b>" + ((this.value==undefined)?'':this.value) + "</b>");}},
                ...
                {key:"updateDate", 		label:"수정일", 			width:"85",		align:"center"},
                {key:"updateNm", 		label:"수정자", 			width:"60",		align:"center"},
                {key:"deleteFlag", 		label:"삭제여부", 		width:"63",		align:"center",	formatter:function(){return (this.value == 'Y'?'<font color=red>' + this.value + '</font>':this.value);}},
                {key:"deleteDate", 		label:"삭제일", 			width:"85",		align:"center"},
                {key:"deleteNm", 		label:"삭제자", 			width:"60",		align:"center"}
            ],
            body : {
    ...
    openParentIdPop: function(openType){
    	...
    	var params = {openType : openType, orgId : $("select[name='targetOrgId']").val() };		// type : set 에서 open OR list open ( 자식 코드 셋때문에 추가 구분 값, default:list )
    ...
    doSaveCodeSet: function(){
		...
		if(!addYn){
			dialog.push({body:"<b>확인!</b> 코드값은 영문자와 _만 가능합니다!", type:"", onConfirm:function(){$('#inputCodeSetName').focus();}});
    		return;
		} */
    	...
    	if(chkCnt>0){
    		dialog.push({body:"<b>확인!</b> 이미 시스템코드로 등록된 코드SET 입니다! <br><br> 다른 코드SET 을 입력해주세요!", type:"", onConfirm:function(){$('#inputCodeSetName').select();}});
    		return;
    	}
    	...
    	var param = {
    			...
    			orgId : $("select[name='targetOrgId']").val(),
    ...
    doSaveCoseList: function(){
		...
		if(!addYn){
			dialog.push({body:"<b>확인!</b> 코드값은 영문자와 _만 가능합니다!", type:"", onConfirm:function(){$('#inputValue').focus();}});
    		return;
		} */
    	...
    	var url = contextRoot + "/system/doSaveCodeList.do";
    	var param = {
  	...
  	//################# else function :E #################
  	 , doRefreshCodeSet : function(){ //부모 코드 set 초기화
  		$("#inputParentSetId").val("");
  		$("#inputParentSetName").val("");
  		$("#inputParentMeaningKor").val("");
  		$("#inputParentMeaningEng").val("");
  	}
    ,doRefreshSonset : function(){ //자식 코드 set 초기화
    	$('#inputSonSetId').val("");
    	$('#inputSonSetName').val("");
    	$('#inputSonMeaningKor').val("");
    	$('#inputSonMeaningEng').val("");
    },openHelpModalPop : function(){	//사용법안내팝업
    	var url = "<c:url value='/system/codeMgmtHelpPop.do'/>";
    	var params = {};

    	myModal.open({
    		url: url,
    		pars: params,
    		titleBarText: '코드관리 사용방법 안내',		//titleBarText 속성 추가하였음.(원 Axisj에는 없었던것)
    		method:"POST",
