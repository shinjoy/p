...
<section id="detail_contents">
	...
	<div class="systemBtnzone">
		<button type="button" class="AXButton Classic btn_auth" onclick="fnObj.addOpen();"><i class="axi axi-add" style="font-size:12px;"></i>권한등록</button>
	</div>
</section>
...
var fnObj = {
    ...
    doSearch: function(page){		//knd : null - 검색버튼, 숫자 - 페이지검색
    	...
    	var callback = function(result){
    		...
    		var orgAccessAuth = getOrgAccessAuth(param["orgSelBox"]);
