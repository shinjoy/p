...
<!-- 증명서 요청내역( 로그인한 사용자가 요청자이거나 대상자인경우. )  -->
<style>
...
<section id="detail_contents">
	...
	<form name="certDocForm" id="certDocForm">
		...
		<input type="hidden" name="keyWord" id="keyWord" value="${vo.keyWord}">
	</form>
        ...
        <!-- 검색 -->
	   	...
	   	<div class="carSearchBox">
	    	<select name="year" id="year" class="select_b w_date" style="margin-left:0px;">
			...
			<input type="text" value="" class="input_b" id="inputStartDate" style="height:24px;" onclick="$(this).val('');"  readonly="readonly"/>
       		...
       		<span class="between_txt">~ </span> <input type="text" id="inputEndDate" onclick="$(this).val('');"  style="height:24px;"  value="" class="input_b" readonly="readonly"/>
       		...
       		<a href="#" onclick="fnObj.doSearch(1);" class="btn_g_black mgl10">검색</a>
		</div><!-- carSearchBox -->
...
var fnObj = {
	...
	certDocView : function(item) {
		...
		$("#certDocForm").attr("action","../system/certDocView.do");
