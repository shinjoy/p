...
<section id="detail_contents">
	...
	<div class="mo_notiBox mgt20">
		...
		<div class="sys_p_noti"><span class="icon_noti"></span><span>인수자 설정시</span> <span class="pointB">비공개 ${baseUserLoginInfo.projectTitle}</span><span>까지 열람가능해집니다. </span></div>
