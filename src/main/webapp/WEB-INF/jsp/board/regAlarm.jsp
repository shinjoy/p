	        ...
	        <colgroup>
                ...
                <col width="*"/>
        		 ...
        		 <tr>
        		 	...
        		 	<td id="targetTd">
        		 		<div class="divORG_MY">
        		 			<a href="javascript:fnObj.userPop('');" id="userBtn" class="btn_select_employee"><em>직원선택</em></a>
...
var fnObj = {
    ...
    addTrTargetSelect : function(dataObj){
    	...
    	if(typeof dataObj == 'object'){
    		...
    		if(dataObj.alarmTargetOrg == 'DEPART') $("#userBtn"+g_rowIdx).attr('class','btn_select_team mgl5');
	  	    else if(dataObj.alarmTargetOrg == 'SEL_USER') $("#userBtn"+g_rowIdx).attr('class','btn_select_employee mgl5');
    ...
    selectAlarmTargetOrg : function(idx){
		...
		if(chkValue != 'NOTICE'){
			...
			if(chkValue == 'DEPART') $("#userBtn"+idx).attr('class','btn_select_team mgl5');
	  	    else if(chkValue == 'SEL_USER') $("#userBtn"+idx).attr('class','btn_select_employee mgl5');
    ...
    getAlarm: function(){
    	...
    	var callback = function(result){
    		...
    		for(var i=0;i<list.length;i++){
    			...
    			if(list[i].alarmOrgScope == "ORG_CHOICE"){
    				...
    				for(var k=0; k<targetInfoList.length; k++){

    					fnObj.addTrTargetSelect(targetInfoList[k]);
    				...
    				if(list[i].alarmTarget == 'DEPART') $("#userBtn").attr('class','btn_select_team');
			  	    else if(list[i].alarmTarget == 'SEL_USER') $("#userBtn").attr('class','btn_select_employee');
    			}
  	...
  	getUserList : function(idx){
	    ...
	    if(idx != ''){
	    	...
	    	if(alarmTarget == 'DEPART') $("#userBtn").attr('class','btn_select_team');
	  	    else $("#userBtn").attr('class','btn_select_employee');
	    }
	...
	userPop : function(idx){
		...
		var applyOrgId ='';
	  	...
	  	if('${pageType}' == 'ONE'){
	  		paramObj ={ name : 'isOneOrg' ,value : 'Y' };
		    paramList.push(paramObj);
	  		paramObj ={ name : 'oneOrgId' ,value : '${baseUserLoginInfo.applyOrgId}'};
	        paramList.push(paramObj);
	  	}
