...
//회사 신규입력하기
function popRgstCpn(actionType,cpnId){
	var popStatus = null;
    if(opener.reOpenCpn){
    	popStatus = opener.reOpenCpn($("#cpnNm").val(), actionType, cpnId);
    }else{
    	popStatus = opener.parent.reOpenCpn($("#cpnNm").val(), actionType, cpnId);
    }
    window.close();
    popStatus.focus();
}
	...
	<div id="compnay_dinfo">
		...
		<div class="modalWrap2">
			...
			<div class="mo_container">
				...
				<div id = "listArea">
					<jsp:include page="../include/popSearchCom_INC.jsp"></jsp:include>
				</div>
				<!--//검색결과有//-->
			</div>
		</div>
