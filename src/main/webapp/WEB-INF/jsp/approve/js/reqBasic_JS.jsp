...
<script type="text/javascript" defer="defer">
	...
	function chkAppointedPersonCallback(data){
		if(data.resultObject.result =="SUCCESS"){
			...
			$("#frm").attr("action",contextRoot+"/approve/insertBasicApprove.do");
	...
	function openApproveProjectPopCallback(projectId , projectName){
		...
		var commonActivity = getCommonProject('CD', 'NM', '', '${baseUserLoginInfo.activityTitle } 선택', { orgId : "${baseUserLoginInfo.orgId }",projectId : projectId  ,type:"ACTIVITY",incApproveActivity:"N",enableChk:"N"});
