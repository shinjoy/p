...
<script type="text/javascript" defer="defer">
	...
	$(document).ready(function(){
		...
		$('#dateTo').datepicker(S_DatePickerOpt).parent().children('img').css({'vertical-align':'middle', 'line-height':'23px', 'margin-left':'5px'});
	...
	function doSave(){
		...
		if(dateToInt > activityEndInt){
			confirmStr = "등록한 교육일정이 ${baseUserLoginInfo.activityTitle }의 일정을 초과합니다. 저장하시겠습니까?";
		}
