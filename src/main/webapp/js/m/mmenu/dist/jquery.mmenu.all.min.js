...
(function(root, factory) {
    ...
    function(e) {
        ...
        e[t].addons[n] = {
            ...
            o.$body.off(a.touchstart + "-" + n).on(a.touchstart + "-" + n, "." + i.panels + "> ." + i.opened, function(e) {
                ...
                that.$pnls.children("." + i.opened).scrollTop(0).css({
            ...
            clickAnchor: function(t, s) {
                ...
                if (s) {
                    ...
                    if (a.length > 1 && "#" == a.slice(0, 1)) try {
                        var o = e(a, this.$menu);
                        if (o.is("." + i.panel))
                            for (var r = parseInt(t.closest("." + i.panel).attr("class").split(i.columns + "-")[1].split(" ")[0], 10) + 1; r !== !1;) {
    ...
    function(e) {
        ...
        function n(n, i, s) {
            ...
            switch (this.opts.offCanvas.position) {
                case "right":
                case "bottom":
                    u.negative = !0, c = function(e) {
                        e >= s.$wndw[m]() - n.maxStartPos && (p = 1)
                    };
                    break;
                default:
                    u.negative = !1, c = function(e) {
                        e <= n.maxStartPos && (p = 1)
                    }
            }
            switch (this.opts.offCanvas.position) {
            ...
            C.on("panstart", function(e) {
                ...
                2 == p && (l = t(b, 10, g) - ("front" == f.opts.offCanvas.zposition ? g : 0), u.negative && (l = -l), d = "translate" + u.typeUpper + "(" + l + "px )", s.$slideOutNodes.css({
                ...
                if (this.opts.offCanvas) {
                    ...
                    if (o = e[t].glbl, "boolean" == typeof l && l && (l = {
                        ...
                        var h = function(e, t) {
                                ...
                                var y, w;
                                return "after" == v ? (y = "x" == e ? b : g, w = _ - (y + C), n[h] = y + d.offset.button[e], n[f] = "auto", s.push(i["x" == e ? "tipleft" : "tiptop"])) : (y = "x" == e ? g : b, w = y - C, n[f] = "calc( 100% - " + (y - d.offset.button[e]) + "px )", n[h] = "auto", s.push(i["x" == e ? "tipright" : "tipbottom"])), n[p] = Math.min(d[u].max, w), [n, s]
                            },
                            f = function(e) {
                                if (this.vars.opened) {
    ...
    function(e) {
        ...
        e[t].addons[n][i] = function(i, s) {
            ...
            var r, l, d;
            return this.bind("openPanel:start", function(e) {
                e.hasClass(a.vertical) || (r = e.find("." + this.conf.classNames[n].panelPrev), r.length || (r = e.children("." + a.navbar).children("." + a.prev)), l = r.attr("href"), d = r.html(), o[l ? "attr" : "removeAttr"]("href", l), o[l || d ? "removeClass" : "addClass"](a.hidden), o.html(d))
    ...
    function(e) {
        ...
        e[t].addons[n][i] = function(i, s) {
            ...
            this.bind("openPanel:start", function(e) {
                e.hasClass(l.vertical) || (r = e.find("." + this.conf.classNames[n].panelTitle), r.length || (r = e.children("." + l.navbar).children("." + l.title)), a = r.attr("href"), o = r.html() || s.title, d[a ? "attr" : "removeAttr"]("href", a), d[a || o ? "removeClass" : "addClass"](l.hidden), d.html(o))
            });
            var c;
                                ...
                                if (!t.is("." + s.panel) || !t.is("." + s.vertical)) {
                                    ...
                                    if (d.noResults) {
                                        ...
                                        if (v || (t = l.$pnls.children("." + s.panel).first()), !t.children("." + s.noresultsmsg).length) {
                                            ...
                                            e('<div class="' + s.noresultsmsg + " " + s.hidden + '" />').append(e[n].i18n(d.noResults))[m.length ? "insertAfter" : "prependTo"](m.length ? m : t)
                                        }
                                    }
                                }
                            }), d.search) {
                                            ...
                                            if (_ = t, d.resultsPanel.add && f.children("." + s.listview).empty(), n.scrollTop(0), m.add(v).addClass(s.hidden).find("." + s.fullsubopensearch).removeClass(s.fullsubopen + " " + s.fullsubopensearch), m.each(function() {
                                                ...
                                                if ("" === _) this.closeAllPanels(), this.openPanel(this.$pnls.children("." + s.subopened).last());
                                                    ...
                                                    n.each(function() {
                                                        ...
                                                        t.length && (d.resultsPanel.dividers && (i = i.add('<li class="' + s.divider + '">' + e(this).children("." + s.navbar).children("." + s.title).text() + "</li>")), i = i.add(t))
            ...
            setup: function() {
                ...
                o = e[t].glbl, "boolean" == typeof r && (r = {
                    ...
                    if (r.add) {
                        ...
                        o.find("." + i.divider).closest("." + i.panel).addClass(i.hasindexer), this.$indexer || (this.$indexer = e('<div class="' + i.indexer + '" />').prependTo(this.$pnls).append('<a href="#a">a</a><a href="#b">b</a><a href="#c">c</a><a href="#d">d</a><a href="#e">e</a><a href="#f">f</a><a href="#g">g</a><a href="#h">h</a><a href="#i">i</a><a href="#j">j</a><a href="#k">k</a><a href="#l">l</a><a href="#m">m</a><a href="#n">n</a><a href="#o">o</a><a href="#p">p</a><a href="#q">q</a><a href="#r">r</a><a href="#s">s</a><a href="#t">t</a><a href="#u">u</a><a href="#v">v</a><a href="#w">w</a><a href="#x">x</a><a href="#y">y</a><a href="#z">z</a>'), this.$indexer.children().on(a.mouseover + "-" + n + " " + i.touchstart + "-" + n, function(t) {
