...
<script src="../../../sp/jquery-1.8.2.min.js"></script>
...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
    	<!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="<c:url value="/PhotoView.do"/>" method="post" enctype="multipart/form-data" onSubmit="return false;">
	        <div id="pop_content2">
    ...
    <div id="pop_container" class="pop_container" style="display:none;">
    	<!-- content -->
		<form id="editor_upimage5" name="editor_upimage5" action="javascript:html5Upload('<c:url value="/Html5PhotoView.do"/>');" method="post" enctype="multipart/form-data" onSubmit="return false;">
	        <div id="pop_content">
