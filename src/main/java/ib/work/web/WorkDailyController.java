...
public class WorkDailyController {
	...
	public void workDailyListByMain(
		...
		String selectType = map.get("selectType").toString();  //ALL(전체), WORK(업무일지), SCHEDULE(일정)
		...
		if("ALL".equals(selectType) || "WORK".equals(selectType)){
			//개인
			map.put("teamYn", 'N');
		...
		if("ALL".equals(selectType) || "SCHEDULE".equals(selectType)){
