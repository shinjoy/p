...
public class Car2DAO extends ComAbstractDAO{
	...
	public int updateCarLog(Map<String, Object> param) throws Exception {
		return update("car2.updateCarLog", param);
	}
	@SuppressWarnings("unchecked")
	...
	@SuppressWarnings("unchecked")
	public Integer deleteCarLog(Map<String, Object> param) throws Exception {
		return delete("car2.deleteCarLog",param);
	}
